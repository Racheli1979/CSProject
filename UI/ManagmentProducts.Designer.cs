namespace UI
{
    partial class ManagmentProducts
    {
        ...
        private void InitializeComponent()
        {
            ...
            inputCategory.Items.AddRange(new object[] { "ספרי_קודש", "סיפורי_צדיקים", "ילדים", "נוער", "מבוגרים", "הסטוריה" });
            ...
            inputUpdateCategory.Items.AddRange(new object[] { "ספרי_קודש", "סיפורי_צדיקים", "ילדים", "נוער", "מבוגרים", "הסטוריה" });
